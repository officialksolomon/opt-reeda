...
LOCAL_APPS = [
    ...
    "core.applications.documents",
    "core.applications.pricing",
]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "OptReeda API",
    "DESCRIPTION": "Documents, optimized for listening. API for document cleaning, domain optimization (Educational & Programming), and audio chunk playback.",
    "VERSION": "0.1.0",
...
REST_AUTH = {
    "USE_JWT": True,
    "JWT_AUTH_COOKIE": "optreeda-auth",
    "JWT_AUTH_REFRESH_COOKIE": "optreeda-refresh",
    "JWT_AUTH_RETURN_EXPIRATION": True,
    "USER_DETAILS_SERIALIZER": "core.applications.users.api.serializers.UserDetailsSerializer",
    "TOKEN_MODEL": None,
}
